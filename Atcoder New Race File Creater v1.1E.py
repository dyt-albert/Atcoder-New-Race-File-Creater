"""
AtCoder New Race File Creator
Author: Albert
Version: v1.1E (English version)
Updated: 2025-2-9
Changes:
    - Updated to use newer PyQt6 instead of PyQt5
"""
...
class Window(QWidget):
    def __init__(self):
        ...
        # Set the window size, title and font
        self.setWindowTitle("Atcoder New Race Files Creater v1.1E")
        self.font = QtGui.QFont("Times New Roman", 14)
        self.main_vbox = QVBoxLayout(self)

        # Create a combo box to select the race type
        race_type_label = QLabel()
        race_type_label.setText("Select the race type:")
        ...
        # Create a line edit for the race number
        race_number_label = QLabel()
        race_number_label.setText("Type the race number:")
        ...
        # Create a radio button for the modes
        sellect_mode_label = QLabel()
        sellect_mode_label.setText("Select the mode:")
    ...
    def to_box(self):
        # Create a group box for the problem
        self.mode_to_gbox = QGroupBox("Problems")
        ...
        # Create a push button for the done action
        self.mode_to_done_btn = QPushButton("Done")
    ...
    def select_box(self):
        # Create a group box for the problem
        self.mode_select_gbox = QGroupBox("Problems")
        ...
        # Create a push button for the done action
        self.mode_select_done_btn = QPushButton("Done")
    ...
    def mode_to_done(self):
        if(self.race_number_lne.text() == ""):
            QMessageBox.question(self, "Error", "Please type the number of the race before create the files", QMessageBox.Ok, QMessageBox.Ok)
            return
    ...
    def check_overwrite_or_not(self, s):
        rep = QMessageBox.question(self, "File Exists", "Do you want to overwrite the file \"" + s + "\"?", QMessageBox.Yes | QMessageBox.No, QMessageBox.No)
    ...
    def clear_main_vbox(self):
        ...
        done_label = QLabel()
        done_label.setText("Create successfully!")
